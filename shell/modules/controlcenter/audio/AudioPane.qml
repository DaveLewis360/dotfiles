                        ...
                        ColumnLayout {
                            ...
                            Repeater {
                                ...
                                delegate: StyledRect {
                                    ...
                                    color: Audio.sink?.id === modelData.id ? Colours.layer(Colours.tPalette.m3surfaceContainer, 2) : "transparent"
                        ...
                        ColumnLayout {
                            ...
                            Repeater {
                                ...
                                delegate: StyledRect {
                                    ...
                                    color: Audio.source?.id === modelData.id ? Colours.layer(Colours.tPalette.m3surfaceContainer, 2) : "transparent"
                                    radius: Appearance.rounding.normal
