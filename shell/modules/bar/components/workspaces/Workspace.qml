...
RowLayout {
    ...
    // Horizontal bar: width-based size instead of height
    ...
    // Horizontal bar: VCenter instead of HCenter
    ...
    StyledText {
        ...
        // Horizontal bar: VCenter + Left alignment
    ...
    Loader {
        ...
        // Horizontal bar: leftMargin instead of topMargin
        Layout.leftMargin: -Config.bar.sizes.innerWidth / 10

        visible: active
        active: root.hasWindows

        // Horizontal bar: Row instead of Column
        sourceComponent: Row {
            spacing: 0
