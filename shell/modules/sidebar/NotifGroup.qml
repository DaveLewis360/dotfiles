...
StyledRect {
    ...
    RowLayout {
        ...
        Item {
            ...
            StyledClippingRect {
                anchors.fill: parent
                color: root.urgency === NotificationUrgency.Critical ? Colours.palette.m3error : root.urgency === NotificationUrgency.Low ? Colours.layer(Colours.tPalette.m3surfaceContainerHigh, 3) : Colours.palette.m3secondaryContainer
            ...
            Loader {
                ...
                sourceComponent: StyledRect {
                    ...
                    color: root.urgency === NotificationUrgency.Critical ? Colours.palette.m3error : root.urgency === NotificationUrgency.Low ? Colours.tPalette.m3surfaceContainerHigh : Colours.palette.m3secondaryContainer
                    radius: Appearance.rounding.full
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                StyledRect {
                    ...
                    color: root.urgency === NotificationUrgency.Critical ? Colours.palette.m3error : Colours.layer(Colours.tPalette.m3surfaceContainerHigh, 3)
                    radius: Appearance.rounding.full
