...
StyledRect {
        ...
        Item {
            ...
            Loader {
                ...
                sourceComponent: StyledRect {
                    radius: Appearance.rounding.full
                    color: root.modelData.urgency === NotificationUrgency.Critical ? Colours.palette.m3error : root.modelData.urgency === NotificationUrgency.Low ? Colours.layer(Colours.tPalette.m3surfaceContainerHighest, 2) : Colours.palette.m3secondaryContainer
    ...
    component Action: StyledRect {
        ...
        radius: Appearance.rounding.full
        color: root.modelData.urgency === NotificationUrgency.Critical ? Colours.palette.m3secondary : Colours.layer(Colours.tPalette.m3surfaceContainerHigh, 2)
