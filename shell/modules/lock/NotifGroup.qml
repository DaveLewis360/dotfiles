...
StyledRect {
    ...
    color: root.urgency === "critical" ? Colours.palette.m3secondaryContainer : Colours.layer(Colours.tPalette.m3surfaceContainerHigh, 2)
    ...
    RowLayout {
        ...
        Item {
            ...
            ClippingRectangle {
                anchors.fill: parent
                color: root.urgency === "critical" ? Colours.palette.m3error : root.urgency === "low" ? Colours.layer(Colours.tPalette.m3surfaceContainerHighest, 3) : Colours.palette.m3secondaryContainer
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                StyledRect {
                    ...
                    color: root.urgency === "critical" ? Colours.palette.m3error : Colours.layer(Colours.tPalette.m3surfaceContainerHighest, 2)
                    radius: Appearance.rounding.full
